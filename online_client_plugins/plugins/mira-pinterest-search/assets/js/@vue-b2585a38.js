...
export {
  ...
  Teleport as V,
  BaseTransition as W,
  BaseTransitionPropsValidators as X,
  Comment as Y,
  DeprecationTypes as Z,
  EffectScope as _,
  createBaseVNode as a,
  popScopeId as a$,
  ErrorTypeStrings as a0,
  KeepAlive as a1,
  ReactiveEffect as a2,
  Static as a3,
  Suspense as a4,
  TrackOpTypes as a5,
  TransitionGroup as a6,
  TriggerOpTypes as a7,
  VueElement as a8,
  assertNumber as a9,
  guardReactiveProps as aA,
  handleError as aB,
  hasInjectionContext as aC,
  hydrate as aD,
  ...
  effect as ax,
  effectScope as ay,
  getTransitionRawChildren as az,
  readonly as b,
  proxyRefs as b0,
  pushScopeId as b1,
  queuePostFlushCb as b2,
  registerRuntimeCompiler as b3,
  render as b4,
  renderList as b5,
  resolveComponent as b6,
  resolveDirective as b7,
  resolveFilter as b8,
  resolveTransitionHooks as b9,
  vModelText as bA,
  version as bB,
  watchPostEffect as bC,
  watchSyncEffect as bD,
  withAsyncContext as bE,
  withDefaults as bF,
  withKeys as bG,
  withMemo as bH,
  withModifiers as bI,
