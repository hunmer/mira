...
const dict: Record<string, string> = {
  ...
  'main.selection.quickImport': '直接导入',
  'main.selection.importTo': '导入到…',
  'main.selection.uploading': '正在导入 {done}/{total}…',
  'main.selection.importedToast': '已导入 {ok} 张{failedSuffix}',
  'main.selection.importedFailedSuffix': '，{n} 张失败',
  ...
  'main.picker.title': '从素材库选择图片',
  'main.picker.add': '从素材库添加',
  'main.picker.selectedCount': '已选 {n} 项（可框选/按住 Ctrl 多选）',
  'main.picker.noLibrary': '暂无素材库',
  'main.image.noTitle': '未命名',
  'main.image.cropSearch': '搜索选中区域',
  'main.image.resetCrop': '清除选区',
  'main.image.restoreOrigin': '恢复默认尺寸',
  'main.image.restoreOriginHint': '恢复为原始种子图并重新搜索',
