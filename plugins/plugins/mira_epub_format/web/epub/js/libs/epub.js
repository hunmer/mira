                    ...
                    _createClass(EpubCFI, [
                        {
                            ...
                            value: function checkType(cfi) {
                                if (this.isCfiString(cfi)) {
                                    ...
                                    (typeof cfi === 'undefined' ? 'undefined' : _typeof(cfi)) ===
                                        'object' &&
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function viewport(options) {
                                    ...
                                    var $viewport =
                                        this.document.querySelector("meta[name='viewport']");
                                    var parsed = {
                                        width: undefined,
                                        height: undefined,
                                        scale: undefined,
                                    ...
                                    if (options) {
                                        ...
                                        if (settings.scalable === 'no') {
                                            ...
                                            if (settings.scalable) {
                                                newContent.push(
                                                    'user-scalable=' + settings.scalable
                                                );
                                            }

                                            if (settings.minimum) {
                                                newContent.push(
                                                    'minimum-scale=' + settings.minimum
                                                );
                                            }

                                            if (settings.maximum) {
                                                newContent.push(
                                                    'minimum-scale=' + settings.maximum
                                                );
                                            }
                                        }
                                                ...
                                                if (
                                                    ...
                                                    this.emit(
                                                            ...
                                                            .LOCATION_CHANGED,
                                                        {
                                                            ...
                                                            percentage:
                                                                this.location.start.percentage
                                                        }
                                                    );
                        ...
                        },
                        {
                            ...
                            value: function page(contents, cfiBase, start, end) {
                                ...
                                if (this._dev === true) {
                                    ...
                                    var startRange = new _epubcfi2.default(result.start).toRange(
                                        doc
                                    );
                                    ...
                                    function (href) {
                                        var replacement = this.createCssFile(
                                            ...
                                            function (replacementUrl) {
                                                ...
                                                if (indexInUrls > -1) {
                                                    this.replacementUrls[indexInUrls] =
                                                        replacementUrl;
                                                }
                                            }.bind(this)
                                        );
