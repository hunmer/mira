(function () {
  ...
  var AiSdkManager = {
    ...
    template: [
      ...
      '  <MiraCard v-if="providers.length" size="sm">',
'    <MiraCardHeader class="border-b"><MiraCardTitle>图片生成</MiraCardTitle></MiraCardHeader>',
'    <MiraCardContent class="space-y-3">',
'      <div class="flex flex-wrap items-end gap-3">',
'        <div class="w-56 space-y-1"><MiraLabel>服务商</MiraLabel>',
...
'          </MiraSelect>',
'        </div>',
'        <MiraButton class="ml-auto" :disabled="generating || !imgModel || !imgPrompt.trim()" @click="generateImages">{{ generating ? "生成中..." : "生成图片" }}</MiraButton>',
'      </div>',
