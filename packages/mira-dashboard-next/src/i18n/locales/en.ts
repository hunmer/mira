export default {
  ...
  databaseScan: {
    ...
    clearing: 'Clearing...',
    newTitle: 'New Files',
    newDesc: 'Find files on disk that are not in the database and import them',
    disableAutoSync: 'Auto sync is enabled. Disable it in library settings first.',
    ...
    newResult: 'Search complete. Added {count} new files.',
