// 文件/文件夹类型 → vscode-file-icons 风格 SVG 图标路径映射
// 图标资源在 public/icons/ 下（相对路径引用，Electron file:// 环境下可用）
// 复刻自 agent_spaces web 的 editor/file-icon.tsx
...
const extMap: Record<string, string> = {
  ...
  ".wmv": "file_type_video",
  ".mid": "file_type_audio",
  ".midi": "file_type_audio",
  ".xsl": "file_type_xml",
  ".rss": "file_type_xml",
  ".ai": "file_type_binary",
  ".eps": "file_type_binary",
  ".dwg": "file_type_binary",
  ".exe": "file_type_binary",
  ".dll": "file_type_binary",
  ".iso": "file_type_binary",
