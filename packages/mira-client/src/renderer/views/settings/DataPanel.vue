<template>
  <div class="p-4 space-y-6">
    <div>
      <h3 class="text-slate-900 text-lg font-bold leading-tight tracking-[-0.015em] pb-2 pt-4">数据管理</h3>
      <p class="text-slate-600 text-sm">导入或导出应用设置</p>
    </div>

    <div class="space-y-4">
      <div class="flex items-center justify-between py-2">
        <div>
          <p class="text-slate-900 text-base font-normal leading-normal">导出设置</p>
          <p class="text-slate-600 text-sm">将当前设置保存为 JSON 文件</p>
        </div>
      ...
      <div class="flex items-center justify-between py-2">
        <div>
          <p class="text-slate-900 text-base font-normal leading-normal">导入设置</p>
          <p class="text-slate-600 text-sm">从 JSON 文件恢复设置</p>
        </div>
