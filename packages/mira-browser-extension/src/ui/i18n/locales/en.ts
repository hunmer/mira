export default {
  ...
  settings: {
    ...
    dragPopoverHosts: 'Enabled sites (one host per line, empty = all)',
    dragPopoverHostsHint: 'Show the drag quick-upload button only on these sites, one host per line (e.g. www.example.com); empty means all sites',
